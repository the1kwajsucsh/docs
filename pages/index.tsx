...
export default function HomePage() {
  return (
    <>
      <Head>
        <title>KWG docs</title>
      </Head>
      <div className="min-h-screen p-8 lg:p-32 bg-gray-50">
        <Link href="/">
          <a aria-label="KWG Docs" className="p-2 block text-3xl text-center lg:text-left">
            <span className="font-bold">Kwa </span>
            <span className="font-normal">docs</span>
          </a>
        </Link>
        <Link href="https://github.com/pmndrs/website/tree/docs">
          <a aria-label="By Pmndrs" className="p-2 block text-1xl text-center lg:text-left">
            <span className="font-italic">Site design by Pmndrs</span>
          </a>
        </Link>
